...
export const LowestFareComp = () => {
  return (
    <div className="relative h-[80%] px-20 py-20 bg-[#bae6fd]">
      <p className="text-sm text-center text-blue-500">CURRENT FARE</p>
      <p className="text-3xl mt-1 text-center text-blue-500">
        Today's Lowest Fare
      </p>
      <div className="flex absolute bottom-16 ml-[18%]">
